...
const ReturnManagement = () => {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Store Returns</h1>
        <p className="text-gray-500 text-sm mt-1">Manage returns heading to your store.</p>
      </div>
