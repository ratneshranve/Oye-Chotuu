...
export default function SupportPage() {
  ...
  const [termsData, setTermsData] = useState({ title: "Support", content: "", updatedAt: "" })
      ...
      <div className="px-4 py-6 pt-[4.5rem]">
        ...
        >
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-gray-900">{termsData.title || "Support"}</h2>
          ...
          {loading ? (
            <p className="text-sm text-gray-500">Loading support...</p>
          ) : termsData.content ? (
            <div
