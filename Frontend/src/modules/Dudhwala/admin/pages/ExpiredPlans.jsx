...
import { 
    Search, Filter, History, User, Clock, 
...
const ExpiredPlans = () => {
    ...
    const fetchPlans = async () => {
        try {
            ...
            toast.error('Failed to load expired plans');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-slate-500">History of completed milk delivery plans.</p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex-1 max-w-md relative">
                            ...
                            <Input 
                                placeholder="Search expired users..." 
                                className="pl-10 border-slate-200 rounded-xl h-11 focus:ring-slate-500 focus:border-slate-500"
                        ...
                        <Button 
                            onClick={fetchPlans} 
                            className="rounded-xl h-11 bg-slate-600 text-white hover:bg-slate-700 transition-all px-8 shadow-sm font-bold"
                        >
                            Search
                        </Button>
                    </div>
                        ...
                        <Table>
                            <TableHeader className="bg-slate-50/50">
                                <TableRow className="border-slate-100">
                                    ...
                                    <TableHead className="text-[11px] font-bold text-slate-500 uppercase tracking-wider px-6 py-4">Expired On</TableHead>
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={6} className="h-32 text-center">
                                            <div className="flex flex-col items-center gap-2">
                                                ...
                                                <p className="text-xs text-slate-400 font-medium">Fetching expired plans...</p>
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                ) : plans.length === 0 ? (
                                    <TableRow>
                                        <TableCell colSpan={6} className="h-32 text-center">
                                            <div className="flex flex-col items-center gap-2 text-slate-500">
                                                ...
                                                <p className="text-sm font-medium">No expired subscriptions found</p>
                                            </div>
                                        </TableCell>
                                    </TableRow>
                                ) : (
                                        ...
                                        <TableRow key={plan._id} className="border-slate-50 hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <TableCell className="px-6 py-4">
                                                <div className="inline-flex flex-col">
                                                    <span className="text-sm font-bold text-slate-700">{plan.totalDays} Days</span>
                                                    <span className="text-[9px] font-bold text-slate-400 uppercase">Total Plan</span>
                                                </div>
                                            </TableCell>
                                            <TableCell className="px-6 py-4">
                                            ...
                                            <TableCell className="px-6 py-4">
                                                <Badge className="bg-slate-100 text-slate-700 border-slate-200">Expired</Badge>
                                            </TableCell>
